...
phi_snaps = []                      # these are lists of arrays!
...
plt.xlabel("x")
plt.ylabel("1000*phi")
plt.title("Piano String Displacement Up to 13ms")
plt.legend()
plt.show()

for index,color in enumerate(colors):
    plt.plot(1000*psi_snaps[index],color,label="t"+str(index))
plt.xlabel("x")
plt.ylabel("1000*psi")
plt.title("Piano String Velocity Up to 13ms")
plt.legend()
plt.show()
